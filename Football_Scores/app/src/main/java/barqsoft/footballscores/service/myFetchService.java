...
public class myFetchService extends IntentService
{
    ...
    private void getData (String timeFrame)
    {
        ...
        catch (Exception e)
        {
            ...
            setServerStatus(getApplicationContext(), SERVER_STATUS_SERVER_INVALID);
        }
        finally {
        ...
        try {
            if (JSON_data != null) {
                ...
                setServerStatus(getApplicationContext(),SERVER_STATUS_SERVER_DOWN);
            }
        }
        catch(Exception e)
        {
    ...
    private void processJSONdata (String JSONdata,Context mContext, boolean isReal)
    {
        ...
        try {
            ...
            updateWidgets();
            setServerStatus(getApplicationContext(),SERVER_STATUS_OK);
